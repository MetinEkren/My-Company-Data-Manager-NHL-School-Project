...
{
    public static void ProductenMenu()
    {
        var ProductenMenulines = new[]
        {
            "1) Klanten",
            "2) Producten",
            "3) Bestellingen",
        ...
        // Teken de box met het ProductenMenu en de titel
        BoxDraw.DrawBox(ProductenMenulines, titel: "Producten");
        ...
        else
        {
            ...
            switch (keuze)
            {
                ...
                default:
                    ...
                    // Roep het ProductenMenu opnieuw aan
                    ProductenMenu();
                    break;
            }
        }
